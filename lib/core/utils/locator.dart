...
Future<void> initLocator() async {
  ...
  locator.registerLazySingleton<DeleteUserActivityUsecase>(
    () => DeleteUserActivityUsecase(locator(), locator(), locator()),
  );
  locator.registerLazySingleton<UpdateUserActivityUsecase>(
    () => UpdateUserActivityUsecase(locator(), locator(), locator()),
  );
  ...
  locator.registerLazySingleton<AddWeightLogUsecase>(
    () => AddWeightLogUsecase(locator(), locator(), locator()),
  );
  locator.registerLazySingleton<DeleteWeightLogUsecase>(
    () => DeleteWeightLogUsecase(locator(), locator()),
  );
  locator.registerLazySingleton<GetWaistLogUsecase>(
    () => GetWaistLogUsecase(locator()),
  );
  locator.registerLazySingleton<AddWaistLogUsecase>(
    () => AddWaistLogUsecase(locator(), locator()),
  );
  locator.registerLazySingleton<DeleteWaistLogUsecase>(
    () => DeleteWaistLogUsecase(locator(), locator()),
  );
  ...
  locator.registerLazySingleton<ConfirmMealPlanToDiaryUsecase>(
    () => ConfirmMealPlanToDiaryUsecase(locator(), locator(), locator()),
  );
  locator.registerLazySingleton<UnconfirmMealPlanFoodUsecase>(
  ...
  locator.registerLazySingleton<DeleteWaterIntakeUsecase>(
    () => DeleteWaterIntakeUsecase(locator(), locator()),
  );
  locator.registerLazySingleton(
  ...
  locator.registerLazySingleton<WaistLogRepository>(
    () => WaistLogRepository(locator()),
  );
  ...
  // Calorie-tracker sync (after repositories — SyncService depends on them)
  locator.registerLazySingleton<CalorieTrackerSyncCredentials>(
    () => CalorieTrackerSyncCredentials(),
  );
  locator.registerLazySingleton<SyncOutboxDataSource>(
    () => SyncOutboxDataSource(locator()),
  );
  locator.registerLazySingleton<CalorieTrackerApiClient>(
    () => CalorieTrackerApiClient(locator(), locator()),
  );
  ...
  locator.registerLazySingleton<AgentToolExecutor>(
    () => AgentToolExecutor(
      ...
      getIntake: locator(),
      addIntake: locator(),
      addTrackedDay: locator(),
      getTrackedDay: locator(),
      getUser: locator(),
  ...
  locator.registerLazySingleton<WaistLogDataSource>(
    () => WaistLogDataSource(hiveDBProvider),
  );
  locator.registerLazySingleton<ConfirmedPlanFoodDataSource>(
    () => ConfirmedPlanFoodDataSource(hiveDBProvider),
  );
  ...
  // Outbox needs Hive's encryption cipher from initHiveDB — open after Hive
  // is ready so enqueue paths do not race the first box open.
  final syncOutbox = locator<SyncOutboxDataSource>();
  await syncOutbox.open();
}
