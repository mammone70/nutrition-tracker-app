...
This project is based on [OpenNutriTracker](https://github.com/simonoppowa/OpenNutriTracker)
...
REST API. Local Hive remains the source of truth for reads; the network is used
only to push queued mutations and pull remote changes when reachable.
